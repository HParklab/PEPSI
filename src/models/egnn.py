...
class E_GCL(nn.Module):
    ...
    def __init__(self, input_nf, output_nf, hidden_nf, edges_in_d = 0, 
        ...
        #     nn.Linear(input_edge + edge_coords_nf + edges_in_d, int(hidden_nf/2)),
        #     act_fn,
        #     nn.Linear(int(hidden_nf/2), int(hidden_nf/2)),
        #     act_fn,
        #     nn.Linear(int(hidden_nf/2), hidden_nf),
        #     act_fn,
        #     nn.Linear(hidden_nf, hidden_nf),
        ...
        #     nn.Linear(hidden_nf*4, hidden_nf*2),
        #     act_fn,
        #     nn.Linear(hidden_nf*2, hidden_nf*1),
        #     act_fn,
        ...
        # coord_mlp.append(act_fn)
        # coord_mlp.append(nn.Linear(hidden_nf*4, hidden_nf*4))
        # coord_mlp.append(act_fn)
        # coord_mlp.append(nn.Linear(hidden_nf*4, hidden_nf*2))
        # coord_mlp.append(act_fn)
